    ...
    >
      <div className="flex items-center justify-between gap-3 max-w-md mx-auto">
        <div className="flex flex-col text-left shrink-0">
          <span className="text-[10px] text-[#4E7A6E] font-bold uppercase tracking-wider">
            Condição Especial
          </span>
          ...
          <span className="text-[9px] text-slate-500 font-medium">ou R$ 147 à vista</span>
        </div>

        <a
          href={checkoutUrl}
          onClick={handleClick}
          className="flex-1 min-h-[48px] bg-[#E07A5F] hover:bg-[#D36A4F] active:scale-[0.98] text-white font-extrabold text-xs uppercase tracking-wide rounded-xl px-3 py-3 flex items-center justify-center gap-1.5 shadow-md transition-all cursor-pointer text-center"
        >
      ...
      <div className="flex items-center justify-center gap-1 text-[9px] text-slate-500 mt-1 font-medium">
        <ShieldCheck className="size-3 text-[#3D7164] shrink-0" />
        <span>Garantia incondicional de 7 dias · 12 meses de acesso</span>
      </div>
    </aside>
  );
}
