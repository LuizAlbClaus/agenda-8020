    ...
    <main className="flex min-h-screen flex-col justify-between bg-[var(--color-canvas)] px-4 py-6 text-[var(--color-ink-solid)] sm:px-8 sm:py-10">
      ...
      <div className="mx-auto my-auto w-full max-w-md">
        <div className="rounded-[var(--radius-card)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-card)] p-6 shadow-[var(--shadow-card-resting)] sm:p-8">
          {/* Structural Calm Lock Badge */}
          <div className="flex size-12 items-center justify-center rounded-full bg-[var(--color-surface-muted)] text-[var(--color-ink-muted)] border border-[var(--color-border-subtle)]">
          ...
          <div className="mt-5">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[var(--color-ink-muted)]">
              Não encontramos um acesso ativo para este email. Se você acabou de comprar, aguarde alguns minutos e tente novamente.
            </p>
          </div>
