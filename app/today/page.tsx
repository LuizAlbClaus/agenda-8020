...
export default async function TodayPage() {
  ...
  const benefit = (Array.isArray(benefitData) ? benefitData[0] : benefitData) as { show_handoff?: boolean; duration_days?: number; status?: string } | null;
